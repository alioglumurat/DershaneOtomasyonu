    ...
    public partial class demirbas : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (sayi > 0)
            {
                ...
                SqlCommand cm = new SqlCommand("select p.adi,p.soyadi,d.personelId,d.adi,d.adet,d.id,d.fiyat,d.lokasyon,d.aciklama,d.tarih from personelProfil as p left join demirbas as d on d.personelId=p.id", db.baglan());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dt = new DataTable();
                dt.Load(db.ozdatagetir("ozdatagetir"));
                dataGridView1.DataSource = dt;
